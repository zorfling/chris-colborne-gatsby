...
Notice a trick here - `address` isn't actually destructured, it's just used to get at its children. If you wanted the full address as well, you could either destructure address first here, then destructure it again, or do a double destructure.
