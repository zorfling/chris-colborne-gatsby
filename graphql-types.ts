...
export type CoursesPageQueryVariables = Exact<{ [key: string]: never; }>;


export type CoursesPageQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
